...
.navbar{
  height: 100px;
	...
	<title>Register|find my wallet</title>
...
@endif
  ...
  {!! csrf_field() !!}
  <div class="col-6 container pt-4 border mt-4" id="login">
  <div class="text-info"><h3>sign up</h3></div>
  ...
  <div class="row mb-4 mt-4">
    ...
    <input type="phone" class="form-control" id="email" placeholder="Enter phone number" name="phone">
  </div>
  ...
  <div>
    <a href="{{ route('lnf.login')}}"> i already have an account,sign me in</a>
  </div>
